package sheep.common.utils;

import sheep.common.exception.ErrorCode;
import sheep.common.exception.ErrorException;
import lombok.Data;
...
public class ResultDTO<T> {
    ...
    public static <T> ResultDTO errorOf(Integer type, String message,T t) {
